...
const error = require('../support/error');
const TIMEOUT = 40000;
...
function createTestFile() {
    fs.writeFileSync('test.js',
        'import error from "./features/support/error.js";\n' +
...
After(async function(testCase) {
    ...
    if (testCase.result.status === Status.FAILED) {
        ...
        error.addErrorToController();
        await error.ifErrorTakeScreenshot(testController)
    }
});
